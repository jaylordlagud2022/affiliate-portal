      ...
      setTimeout(() => {
        resolve({
          ...
          data: {
            ...
            // Set currentApplicationStatus to 'registered' to see the icon on the first line
            // Change this to 'reviewed', 'approved', or 'active' to see it move
            currentApplicationStatus: 'registered', // This will determine the active step
          },
        });
...
const AffiliateActivity: React.FC = () => {
  ...
  const [applicationStatus, setApplicationStatus] = useState<ApplicationStatus>('registered'); // Initialized to 'registered'
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-200">
            <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-200">
              <h2 className="text-3xl font-extrabold text-gray-800">AFFILIATE OVERVIEW</h2>
              <button
              ...
              <>
                  ...
                  {progressSteps.map((step, index) => (
                    <React.Fragment key={step}>
                      <div className="flex flex-col items-center flex-1 min-w-[80px] text-center px-1">
                        ...
                        >
                          {/* Icon logic for step circles: Always show checkmark if complete, arrow if active */}
                      ...
                      {index < progressSteps.length - 1 && (
                        ...
                        >
                          {/* Home icon on the line segment that corresponds to the active step */}
                          {index === progressSteps.indexOf(applicationStatus) && (
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full p-1 border">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16"
                                className={`w-4 h-4
                                  ${isStepActive(progressSteps[index]) ? 'text-blue-600' : 'text-gray-500'}`}
                              >
                                <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L8.707 1.5Z"/>
                                <path d="M11.5 14.5a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .146-.354L7.293 4.5a.5.5 0 0 1 .414 0l3.647 3.646a.5.5 0 0 1 .146.354v7Z"/>
                              </svg>
                            </div>
                          )}
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                  <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-md transition-shadow">
                    ...
                    {/* FIX: Removed '$' from inside curly braces for correct JSX parsing */}
